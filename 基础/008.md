> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [juejin.cn](https://juejin.cn/post/6909731086977368078/#heading-1)
...
1.  初始化 package.json 文件 输入指令：npm init
...
2.  下载 loader 安装包 `npm install --save-dev postcss-loader postcss-preset-env`
